				...
				const char *name)
{
	 ...
	 */
/*2019.12.17 edit longcheer xiaoxiongfeng "Increase the hibernation info of the rpmh subsystem" satrt*/
...
/*2019.12.17 edit longcheer xiaoxiongfeng "Increase the hibernation info of the rpmh subsystem" end*/
...
/*2019.12.17 edit longcheer xiaoxiongfeng "Increase the hibernation info of the rpmh subsystem" start*/
