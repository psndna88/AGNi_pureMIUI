...
#define sap_alert(params...)
#define sap_err(params...)
#define sap_warn(params...)
#define sap_info(params...)
...
#define sap_alert_rl(params...)
#define sap_err_rl(params...)
#define sap_warn_rl(params...)
#define sap_info_rl(params...)
