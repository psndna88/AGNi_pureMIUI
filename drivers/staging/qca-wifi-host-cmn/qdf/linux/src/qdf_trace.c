...
static bool qdf_log_dump_at_kernel_enable = false;
...
static void set_default_trace_levels(struct category_info *cinfo)
{
	...
	static QDF_TRACE_LEVEL module_trace_default_level[QDF_MODULE_ID_MAX] = {
		...
		[QDF_MODULE_ID_MBSSIE] = QDF_TRACE_LEVEL_NONE,
		[QDF_MODULE_ID_FWOL] = QDF_TRACE_LEVEL_NONE,
		[QDF_MODULE_ID_SM_ENGINE] = QDF_TRACE_LEVEL_NONE,
		[QDF_MODULE_ID_CMN_MLME] = QDF_TRACE_LEVEL_NONE,
		[QDF_MODULE_ID_BSSCOLOR] = QDF_TRACE_LEVEL_NONE,
		...
		[QDF_MODULE_ID_QLD] = QDF_TRACE_LEVEL_NONE,
		[QDF_MODULE_ID_DYNAMIC_MODE_CHG] = QDF_TRACE_LEVEL_NONE,
		[QDF_MODULE_ID_COEX] = QDF_TRACE_LEVEL_NONE,
		[QDF_MODULE_ID_MON_FILTER] = QDF_TRACE_LEVEL_NONE,
...
/*	if (qdf_log_dump_at_kernel_enable == enable) {
	...
	qdf_log_dump_at_kernel_enable = false;
}
