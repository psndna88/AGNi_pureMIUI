...
#define mlme_legacy_fatal(params...)
#define mlme_legacy_err(params...)
#define mlme_legacy_warn(params...)
#define mlme_legacy_info(params...)
#define mlme_legacy_debug(params...)
