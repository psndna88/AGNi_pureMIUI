...
sed -i 's/v12.6_stable-EAS/v12.7_stable-EAS/' $KERNELDIR/arch/arm64/configs/agni_*
sed -i 's/ini_set("rom_version",	"v12.6_stable");/ini_set("rom_version",	"v12.7_stable");/' $KERNELDIR/anykernel3/META-INF/com/google/android/aroma-config
