...
export AGNI_VERSION="v13.0"
sed -i 's/v12.9_stable-EAS/v13.0_stable-EAS/' $KERNELDIR/arch/arm64/configs/agni_*
sed -i 's/ini_set("rom_version",	"v12.9_stable");/ini_set("rom_version",	"v13.0_stable");/' $KERNELDIR/anykernel3/META-INF/com/google/android/aroma-config
