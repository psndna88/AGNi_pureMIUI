...
sed -i 's/v11.6_beta3-EAS/v11.6_stable-EAS/' $KERNELDIR/arch/arm64/configs/agni_*
sed -i 's/ini_set("rom_version",	"v11.6_beta3");/ini_set("rom_version",	"v11.6_stable");/' $KERNELDIR/anykernel3/META-INF/com/google/android/aroma-config
