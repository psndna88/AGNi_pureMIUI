...
sed -i 's/v11.3_stable-EAS/v11.4_beta1-EAS/' $KERNELDIR/arch/arm64/configs/agni_*
sed -i 's/ini_set("rom_version",	"v11.3_stable");/ini_set("rom_version",	"v11.4_beta1");/' $KERNELDIR/anykernel3/META-INF/com/google/android/aroma-config
