...
mkdir -p $KERNELDIR/BUILT_kenzo-cmMM/lib/modules/

find -name '*.ko' -exec mv -v {} $KERNELDIR/BUILT_kenzo-cmMM/system/lib/modules/ \;
mv $KERNELDIR/BUILT_kenzo-cmMM/system/lib/modules/fpc1020_tee.ko $KERNELDIR/BUILT_kenzo-cmMM/lib/modules/
mv $KERNELDIR/BUILT_kenzo-cmMM/system/lib/modules/gf.ko $KERNELDIR/BUILT_kenzo-cmMM/lib/modules/
