...
#line 434 "dtc-parser.y"
    { (yyval.integer) = (yyvsp[-2].integer) > (yyvsp[0].integer); }
#line 1925 "dtc-parser.tab.c"
    break;

  case 61:
#line 435 "dtc-parser.y"
    { (yyval.integer) = (yyvsp[-2].integer) <= (yyvsp[0].integer); }
#line 1931 "dtc-parser.tab.c"
    break;

  case 62:
#line 436 "dtc-parser.y"
    { (yyval.integer) = (yyvsp[-2].integer) >= (yyvsp[0].integer); }
#line 1937 "dtc-parser.tab.c"
    break;

  case 63:
#line 440 "dtc-parser.y"
    { (yyval.integer) = (yyvsp[-2].integer) << (yyvsp[0].integer); }
#line 1943 "dtc-parser.tab.c"
    break;

  case 64:
#line 441 "dtc-parser.y"
    { (yyval.integer) = (yyvsp[-2].integer) >> (yyvsp[0].integer); }
#line 1949 "dtc-parser.tab.c"
    break;

  case 66:
#line 446 "dtc-parser.y"
    { (yyval.integer) = (yyvsp[-2].integer) + (yyvsp[0].integer); }
#line 1955 "dtc-parser.tab.c"
    break;
...
#line 2085 "dtc-parser.tab.c"
    break;


#line 2089 "dtc-parser.tab.c"
