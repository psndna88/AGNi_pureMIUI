...
#undef POWER_SUSPEND_DEBUG // Add debugging prints in dmesg
...
static int state = POWER_SUSPEND_ACTIVE; // Yank555.lu : Current powersave state (screen on / off)
static int mode = POWER_SUSPEND_HYBRID;  // Yank555.lu : Current powersave mode  (kernel / userspace / panel / hybrid)
